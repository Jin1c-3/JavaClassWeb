package com.yutech.javacovid.service;

import com.yutech.javacovid.bean.Category;
import com.yutech.javacovid.mapper.CategoryMapper;
...
public class CategoryService {
	...
	public String storeFile(MultipartFile file) {
		...
		System.out.println("CategoryService->storeFile--> " + realPath + " 此位置将被用作存储，请检查");
